export function userLogin     (state = "",    action) { switch (action.type) { case "USER_SET_LOGIN":      return action.userLogin;
                                                                               default:                    return state; } }
export function userPassw     (state = "",    action) { switch (action.type) { case "USER_SET_PASSW":      return action.userPassw;
                                                                               default:                    return state; } }
export function userIsLoading (state = false, action) { switch (action.type) { case "USER_IS_LOADING":     return action.userIsLoading;
                                                                               default:                    return state; } }
